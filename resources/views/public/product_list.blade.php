...
<script type="text/javascript" src='http://maps.google.com/maps/api/js?key=AIzaSyAvIsz3M59Jyze3pfpZSXcOmFzH7KQ79Ys&libraries=places'></script>
<script src="{{ asset('js/locationpicker.jquery.js')}}"></script>
<style>

    .pg-list-auto {
        background: url("/uploads/products/<?php echo $product->cover; ?>") no-repeat;
    }[class~=pg-list-1]{background:url("/uploads/products/<?php echo $product->cover; ?>") no-repeat;}
</style>
...
<section class="pg-list-1 pg-list-auto">
    <div class="container">
        <div class="row">
            <div class="pg-list-1-left"> <a href="#"><h3>{{$product->name_en}}</h3></a>
                <div class="list-rat-ch"> <span>{{$product->total_rate}}</span>
                    <?php
...
<!--                    <i class="fa fa-star" aria-hidden="true"></i> 
                ...
                <div class="list-number pag-p1-phone">
                    <ul>
                        <li><i class="fa fa-phone" aria-hidden="true"></i> +01 8521 3658</li>
                        <li><i class="fa fa-envelope" aria-hidden="true"></i> marketshop@webdir.com</li>
        ...
        <div class="row">
            <div class="com-padd">
                <div class="list-pg-lt list-page-com-p">
                    ...
                    <div class="pglist-p1 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti">
                            <h3><span>About</span> {{$product->name_en}}</h3> </div>
                    ...
                    <div class="pglist-p2 pglist-bg pglist-p-com">
                        ...
                        <div class="list-pg-inn-sp">
                            ...
                            <div class="row pg-list-ser">
                                <ul>
                                    <li class="col-md-4">
                                        <div class="pg-list-ser-p1"><img src="/front/images/services/a1.jpg" alt="" /> </div>
                                        <div class="pg-list-ser-p2">
                                            <h4>Car Buying</h4> </div>
                                    </li>
                                    <li class="col-md-4">
                                        <div class="pg-list-ser-p1"><img src="/front/images/services/a2.jpg" alt="" /> </div>
                                        <div class="pg-list-ser-p2">
                                            <h4>Motor bikes</h4> </div>
                                    </li>
                                    <li class="col-md-4">
                                        <div class="pg-list-ser-p1"><img src="/front/images/services/a3.jpg" alt="" /> </div>
                                        <div class="pg-list-ser-p2">
                                            <h4>Bike Alteration</h4> </div>
                                    </li>
                                    <li class="col-md-4">
                                        <div class="pg-list-ser-p1"><img src="/front/images/services/a4.jpg" alt="" /> </div>
                                        <div class="pg-list-ser-p2">
                                            <h4>Repair Shop</h4> </div>
                                    </li>
                                    <li class="col-md-4">
                                        <div class="pg-list-ser-p1"><img src="/front/images/services/a5.jpg" alt="" /> </div>
                                        <div class="pg-list-ser-p2">
                                            <h4>Insurance</h4> </div>
                                    </li>
                                    <li class="col-md-4">
                                        <div class="pg-list-ser-p1"><img src="/front/images/services/a6.jpg" alt="" /> </div>
                                        <div class="pg-list-ser-p2">
                    ...
                    <div class="pglist-p3 pglist-bg pglist-p-com">
                        ...
                        <div class="list-pg-inn-sp">
                            <div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
                                <!--LISTINGS IMAGE-->
                                <div class="col-md-3"> <img src="/front/images/room/a1.jpg" alt=""> </div>
                                <!--LISTINGS: CONTENT-->
                                <div class="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta"> <a href="#!"><h3>BWM Bikes</h3></a>
                                    ...
                                    <div class="list-room-type list-rom-ami">
                                        <ul>
                                            ...
                                            <li><img src="/front/images/icon/a7.png" alt=""> Max Power:13000 rpm</li>
                                            <li><img src="/front/images/icon/a4.png" alt=""> Fuel Type:Petrol </li>
                                            <li><img src="/front/images/icon/a3.png" alt=""> Gears:6</li>
                                            <li><img src="/front/images/icon/a2.png" alt=""> Brake Type:Disc</li>
                                            <li><img src="/front/images/icon/a5.png" alt=""> Cylinders:5</li>
                                            <li><img src="/front/images/icon/a6.png" alt=""> Wheel Size: 17inc</li>
                                            <li><img src="/front/images/icon/a9.png" alt=""> Wheel Type: Alloy</li>
                                        </ul>
                            ...
                            <div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
                                <!--LISTINGS IMAGE-->
                                <div class="col-md-3"> <img src="/front/images/room/a2.jpg" alt=""> </div>
                                <!--LISTINGS: CONTENT-->
                            ...
                            <div class="home-list-pop list-spac list-spac-1 list-room-mar-o">
                                <!--LISTINGS IMAGE-->
                                <div class="col-md-3"> <img src="/front/images/room/a3.jpg" alt=""> </div>
                                <!--LISTINGS: CONTENT-->
                                ...
                                <form class="col" id="form-review">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input  type="text" class="validate" id="review_name" required>
                                            <label for="name">Full Name</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input  type="number" id="review_mobile" class="validate" required>
                                            <label for="mobile">Mobile</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input  type="email" id="review_email" class="validate" required>
                                            <label for="email">Email id</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input  type="text" class="validate" id="review_city" required>
                                            <label for="city">City</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <textarea  class="materialize-textarea" id="review_review" required></textarea>
                                            <label for="review">Write review</label>
                                        </div>
                                        <input id="review_product_id" type="hidden" value="{{$product->id}}">
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12"> <a class="waves-effect waves-light btn-large full-btn" id="review-btn" href="#!">Submit Review</a> </div>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="pglist-p3 pglist-bg pglist-p-com">
                        ...
                        <div class="list-pg-inn-sp">
                            ...
                            <div class="lp-ur-all-rat">
                                ...
                                <ul>
                                    <li>
                                        <div class="l                                                                    r-user-wr-img"> <img src="/front/images/users/2.png" alt=""> </div>
                                        <div class="lr-user-wr-con">
                                            <h6>Jac                                                                        ob Michael <span>4.5 <i class="fa fa-star" aria-hidden="true"></i></span></h6> <span class="lr-revi-date">19th January, 2017</span>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#!"><s                                                                                                                                    pan>Report</span> <i class="fa fa-flag-o" aria-hidden="true"></i></a> </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="lr-user-wr-con">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="#!"><span>Comments</span> <i class="fa fa-commenting-o" aria-hidden="true"></i></a> </li>
                                                <li><a href="#!"><span>Share Now</span>  <i class="fa fa-facebook" aria-hidde                                                                                                                                                                                                        n="true"></i></a> </li>
                                                <li><a href="#!"><i class="fa fa-google-plus" aria-hidden="true"></i></a> </li>
                                                <li><a href="#!"><i class="fa fa-twitter" aria-hidden="true"></i></a> </li>
                                                <li><a href="#!"><i class="fa fa-linkedin" aria-hidden="true"></i></a> </li>
                                                <li><a href="#!"><i class="fa fa-youtube" aria-hidden="true"></i></a> </li>
                                    ...
                                    <li>
                                        <div class="lr-user-wr-img"> <img src="/front/images/users/6.png" alt=""> </div>
                                        <div class="lr-user-wr-con">
                ...
                <div class="list-pg-rt">
                    ...
                    <div class="pglist-p3 pglist-bg pglist-p-com">
                        ...
                        <div class="list-pg-inn-sp">
                            <div class="list-pg-guar">
                                <ul>
                                    <li>
                                        <div class="list-pg-guar-img"> <img src="/front/images/icon/g1.png" alt="" /> </div>
                                        <h4>Service Guarantee</h4>
                                        <p>Upto 6 month of service</p>
                                    </li>
                                    <li>
                                        <div class="list-pg-guar-img"> <img src="/front/images/icon/g2.png" alt="" /> </div>
                                        <h4>Professionals</h4>
                                        <p>100% certified professionals</p>
                                    </li>
                                    <li>
                                        <div class="list-pg-guar-img"> <img src="/front/images/icon/g3.png" alt="" /> </div>
                                        <h4>Insurance</h4>
                    ...
                    <!--LISTING DETAILS: LEFT PART 7-->
                    <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pg-list-user-pro"> <img src="/front/images/users/8.png" alt=""> </div>
                        <div class="list-pg-inn-sp">
                            <div class="list-pg-upro">
                                <h5>Kevin Jack</h5>
                                <p>Member since July                                                                                                                                                                                                         2017</p> <a class="waves-effect waves-light btn-large full-b                                                                                                                                                                                                        tn list-pg-btn" href="#!">Contact User</a> </div>
                        </div>
                    </div>
                    <!--END LISTING DETAILS: LEFT PART 7-->
                    ...
                    <div class="pglist-p3 pglist-bg pglist-p-com">
                        ...
                        <div class="list-pg-inn-sp">
                            ...
                            <!--<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6290413.804893654!2d-93.99620524741552!3d39.66116578737809!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880b2d386f6e2619%3A0x7f15825064115956!2sIllinois%2C+USA!5e0!3m2!1sen!2sin!4v1469954001005" allowfullscreen></iframe>-->
                                <iframe frameborder="0" scrolling="no"  marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q='+{{$product->latitude}}+','+{{$product->longitude}}+'&z=20&hl=es;z=20&amp;output=embed">
                                </iframe>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pglist-p3 pglist-bg pglist-p-com">
                        <div class="pglist-p-com-ti pglist-p-com-ti-right">
                            <h3><span>Other</span> In                                                                                                                                                                                                        formations</h3> </div>
                        <div class="list-pg-inn-sp">
                    ...
                    <div class="list-mig-like">
                        ...
                        <a href="#!">
                            <div class="list-mig-like-com">
                                <div class="list-mig-lc-img"> <img src="/front/images/listing/1.jpg" alt="" /> <span class="home-list-pop-rat list-mi-pr">$720</span> </div>
                        ...
                        <a href="#!">
                            <div class="list-mig-like-com">
                                <div class="list-mig-lc-img"> <img src="/front/images/listing/2.jpg" alt="" /> <span class="home-list-pop-rat list-mi-pr">$420</span> </div>
                                <div class="list-mig-lc-con">
                        ...
                        <a href="#!">
                            <div class="list-mig-like-com">
                                <div class="list-mig-lc-img"> <img src="/front/images/listing/3.jpg" alt="" /> <span class="home-list-pop-rat list-mi-pr">$380</span> </div>
                                <div class="list-mig-lc-con">
                                    <div class="list-rat-ch list-room-rati"> <span>5.0</span> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> </div>
                ...
                <div class="modal-body dir-pop-body">
                    <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group has-feedback ak-field">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="" class="form-control" name="fname" placeholder="" required> </div>
                        </div>
                        <!--LISTING INFORMATION-->
                        <div class="form-group has-feedback ak-field">
                            <label class="col-md-4 control-label">Mobile</label>
                            <div class="col-md-8">
                                <input type="text" id="" class="form-control" name="mobile" placeholder="" required> </div>
                        </div>
                        <!--LISTING INFORMATION-->
                        <div class="form-group has-feedback ak-field">
                            <label class="col-md-4 control-label">Email</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="" name="email" placeholder="" required> </div>
                        </div>
                        <!--LISTING INFORMATION-->
                        <div class="form-group has-feedback ak-field">
