...
<!--    <script src="https://code.jquery.com/jquery-1.10.2.min.js"></script>
    ...
    <script src="{{asset('js/locationpicker.jquery.js')}}" type="text/javascript"></script>
    ...
    <body class="page-sidebar-fixed @if(getUserSystem('backend_header')=='fixed') page-header-fixed @endif page-sidebar-closed-hide-logo page-content-white @if(getUserSystem('backend_layout')=='fixed') page-boxed @endif @if(getUserSystem('backend_footer')=='fixed') page-footer-fixed @endif @if(getUserSystem('backend_sidebar_menu_position')=='right') page-sidebar-reversed @endif @if(Request::path()=='admin/notifications') page-sidebar-closed @endif">
        <div class="page-wrapper">
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2017 &copy; Almoasher</div>
...
//<![CDATA[
        bkLib.onDomLoaded(function() { 
            nicEditors.allTextAreas( {buttonList : ['bold','italic','underline','left','center','right','justify','ol','ul','forecolor','bgcolor']}   ) ;
nicEditor({buttonList : ['fontSize','bold','italic','underline','strikeThrough','subscript','superscript','html','image']});
